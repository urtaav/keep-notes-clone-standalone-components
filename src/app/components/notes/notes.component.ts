...
import { CheckboxI, NoteI } from 'src/app/interfaces/notes';
// @ts-ignore
import Bricks from 'bricks.js'
import { ph } from 'src/app/pipes/ph.pipe';
import { InputComponent } from '../input/input.component';
import { CboxSortPipe } from 'src/app/pipes/cbox-sort.pipe';
import { CboxDonePipe } from 'src/app/pipes/cbox-done.pipe';
...
@Component({
  selector: 'keep-notes',
  standalone: true,
  imports: [CommonModule,InputComponent,CboxSortPipe,CboxDonePipe,NotesToolsPipe, ph],
...
export class NotesComponent {
  ...
  moreMenu(tooltipEl: HTMLDivElement) {
    ...
    let actions = {
      ...
      openLabelMenu: (tooltipEl: HTMLDivElement) => {
        ...
        this.Shared.note.db.get().then((note:any) => {
          note.labels.forEach((noteLabel:any) => {
  ...
  ngOnInit(): void {
    ...
    console.log("Shared",this.Shared.note.all)
